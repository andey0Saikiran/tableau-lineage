  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3">
      ...
      <button
        type="button"
        onClick={onReset}
        className="group inline-flex items-center gap-2.5 rounded-xl border border-slate-300/80 bg-gradient-to-b from-white to-slate-100 px-5 py-2.5 text-sm font-bold text-ink shadow-[inset_0_1px_0_rgba(255,255,255,0.95),0_2px_4px_rgba(15,23,42,0.10),0_6px_16px_-5px_rgba(15,23,42,0.18)] transition-all duration-200 ease-out hover:-translate-y-0.5 hover:border-brand-400 hover:text-brand-700 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.95),0_4px_10px_rgba(14,165,233,0.18),0_12px_26px_-6px_rgba(14,165,233,0.30)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-2 active:translate-y-0 active:shadow-[inset_0_2px_5px_rgba(15,23,42,0.14)] motion-reduce:transition-none motion-reduce:hover:translate-y-0"
      >
